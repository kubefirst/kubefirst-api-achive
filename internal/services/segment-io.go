...
func (service SegmentIoService) EnqueueCountMetric(metricName string, domain string, cliVersion string, kubeFirstTeam string, clusterType string, clusterId string) error {
